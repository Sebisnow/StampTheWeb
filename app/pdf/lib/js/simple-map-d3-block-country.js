...
function SimpleMapD3(o) {
  ...
  var defaults = {
    ...
    tooltipContent: function(d) {
	  ...
	  output = output.replace('Block: 0<br />','')
	  output = output.replace('Block: 2<br />','')
	  output = output.replace('Block: 1<br />','')
      return output;
    },
  ...
  smd.drawCanvas = function() {
    ...
    smd.draggableMapGroup = smd.canvas.append('g')
      ...
      .attr('transform', 'scale(1.0) translate(' + mapOffset + ')');
  ...
  smd.makeColorRange = function() {
	...
	smd.valuesSet.push(1);
	smd.valuesSet.push(2);
  ...
  smd.drawLegend = function() {
    ...
    if (smd.options.colorScale === 'quantize') {
	  ...
	  legendSwatches.push(1);
	  legendSwatches.push(2);
